...
/** Parameters controlling how {@link NexmarkGenerator} synthesizes {@link model} elements. */
public class GeneratorConfig extends UserConfiguration implements Serializable {
    ...
    public static final long ZIPF_WARMUP_MILLIS = 60000L;
...
//    public final long maxEvents;
    ...
    public final NexmarkUtils.RateShape rateShape;
    ...
    public GeneratorConfig(
        ...
        this.rateShape = configuration.rateShape;
    }
    ...
    public List<GeneratorConfig> split(int n) {
        ...
        if (n == 1) {
            ...
            // use maxEvents as per worker events
            long subMaxEvents = maxEvents;
    ...
    public GeneratorConfig copyWith(long firstEventId, long maxEvents, long firstEventNumber) {
        GeneratorConfig ret = new GeneratorConfig(
    ...
    public void resetBaseTime(long time) { this.baseTime = time; }
    ...
    public long timestampForEventZipf(long last, long incr) {
        return last + incr;
    }
